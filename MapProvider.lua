...
for i = 1, #mapProvider.tileLevels do
	mapProvider.tileLevels[i].level = settings.global["ti-level-" .. mapProvider.tileLevels[i].name].value
end
...
mapProvider.persistance = settings.global["ti-noise-persistence"].value
